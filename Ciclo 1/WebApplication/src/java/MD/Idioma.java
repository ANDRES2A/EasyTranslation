 ...
 */
@Entity
@Table(name = "IDIOMA", catalog = "", schema = "EASYTRANSLATION")
@XmlRootElement
@NamedQueries({
...
public class Idioma implements Serializable {
    ...
    @JoinTable(name = "SABE_REVISOR", joinColumns = {
        @JoinColumn(name = "ABREVIACION_ID", referencedColumnName = "ABREVIACION_ID")}, inverseJoinColumns = {
        @JoinColumn(name = "CORREO_RE", referencedColumnName = "CORREO_RE")})
    @ManyToMany
    private Collection<Revisor> revisorCollection;
    @ManyToMany(mappedBy = "idiomaCollection")
